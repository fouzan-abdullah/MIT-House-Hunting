# house hunting with a raise: determine how long it will take you to save enough money to make the down payment
...
while current_savings < portion_down_payment:
    ...
    num += 1
    if num % 6 == 0:
        monthly_savings = ((annual_salary + annual_salary * semi_annual_raise) / 12) * portion_saved
print(num)
